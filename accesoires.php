...
try {
    ...
    if (isset($_GET['search']) && !empty($_GET['search'])) {
        ...
        $stmt = $conn->prepare("SELECT id, nam, price, image_url FROM products WHERE categorie_id = 'accessoires'");
    }
...
<body>
    <header>
        ...
        <div class="header-search-container">
            <form method="GET" action="accesoires.php" class="header-search-form">
